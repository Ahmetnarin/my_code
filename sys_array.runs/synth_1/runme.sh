...
HD_PWD='C:/Users/Ahmet/Desktop/prezentasyonda kullanacaklarin/SA/sys_array.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log control_matr_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source control_matr_mult.tcl
